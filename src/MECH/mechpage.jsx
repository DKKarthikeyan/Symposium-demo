...
function Mech() {
        const navigate = useNavigate();
         const events = [
                  { title: "TECHNICAL EVENTS", image: cse, link: "/mech/mechtech"  },
                  { title: "NON-TECHNICAL EVENTS", image: civil,link: "/mech/mechnontech" },
    ...
    return (
        <>
            <h1 className='ps-5 mt-4 bigText fontOne'><i className='primaryColor'>/ </i>MECH</h1>
