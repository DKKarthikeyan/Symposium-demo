...
function SponsorCard2({sponsorName,sponsorDesc,sponsorLink,sponsorImage,sponsorCategory}) {
  return (
    <div className='container-lg mt-0 mt-lg-5 pt-3 pb-4 px-4 about1'>
            <div className="row justify-content-between align-items-center">
    
            <div className="col-md-6 col-lg-5 border borderColor p-4 d-flex flex-column align-items-center justify-content-center sponsorImage">
                ...
                <div className="col-md-6 col-lg-6  pe-4 pe-md-0 ps-4 ps-lg-0  mt-4 mt-lg-0 ">
