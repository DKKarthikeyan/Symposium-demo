...
Evaluation Criteria: Based on individual and team performance, creativity, problem-solving, innovation, user impact, and engagement.                                                                                                                                   </p>
                                                                                                       ...
                                                                                                       <button className="closed-btn mt-3 mt-sm-0" style={{margin:'0px 50px'}}><a href="pdf/HACKATHON.pdf" download="HACKATHON.pdf" style={{textDecoration:'none',textDecorationColor:'none'}}>Download PDF</a></button>
                                                                                                                       </div>
