...
function Elo(){
     ...
     const contacts = [
        { name: "DR. K. DHAHAGANI", number: "6385504190" },
    ...
    return(
        <>
         < div className="header">
                                                                                             <span className="primaryColor">/</span><span>Elocumania</span>
                                                                                ...
                                                                                <div className="row mb-5">
                                                                                                 ...
                                                                                                 <div className="text-container">
                                                                                                           ...
                                                                                                           {activeTab === "Rounds" && (
                                                                                                               <div className="tab-content">
                                                                                                                   <p>
                                                                                                                   Unleash the power of your words at Elocumania, the ultimate elocution competition! Dive into the world of green energy and inspire change with your ideas.
                                                                                                                   </p>
                                                                                                                   {/* <div className="row">
                                                                                                   ...
                                                                                                   <div className="row">
                                                                                                       ...
                                                                                                       <div className="col-md-6">
                                                                                                           ...
                                                                                                           <div className="round-card">
                                                                                                               <h5><FaClipboardList style={{fontSize:'16px'}} /> Talk brave</h5>
